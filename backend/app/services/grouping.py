...
HEBREW_CATEGORY_MAP: dict[str, str] = {
    ...
    "ענבים": "ירקות ופירות",
    "תות": "ירקות ופירות",
    "אוכמניות": "ירקות ופירות",
    "שום": "ירקות ופירות",
    "ג'ינג'ר": "ירקות ופירות",
    "זנגביל": "ירקות ופירות",
    "בזיליקום": "ירקות ופירות",
    "כוסברה": "ירקות ופירות",
    "פטרוזיליה": "ירקות ופירות",
    "פטריות": "ירקות ופירות",
    "כרוב": "ירקות ופירות",
    "ברוקולי": "ירקות ופירות",
    "כרובית": "ירקות ופירות",
    "סלרי": "ירקות ופירות",
    "קישוא": "ירקות ופירות",
    "חציל": "ירקות ופירות",
    ...
    "חיתול": "תינוקות",
    "חיתולים": "תינוקות",
    "מזון תינוקות": "תינוקות",
    "מגבוני תינוקות": "תינוקות",
    "תמ\"ל": "תינוקות",
    "תחליף חלב": "תינוקות",
    # חיות מחמד (Pet)
    "מזון כלבים": "חיות מחמד",
    "מזון חתולים": "חיות מחמד",
    "אוכל לכלב": "חיות מחמד",
    "אוכל לחתול": "חיות מחמד",
}

# ── All known departments (for autocomplete) ─────────────────────
DEPARTMENTS_EN = [
...
# Bidirectional mapping between EN and HE department names
...
# Regex pattern for detecting Hebrew characters
...
async def guess_category_smart(item_name: str) -> str | None:
    ...
    Use this in async contexts (API endpoints, WebSocket handlers).
    """
